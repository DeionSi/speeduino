...
timedEvent mt_test0_events[] {
  ...
  { timedEvent::PRITRIG, 3000,  timedEventArrayTestEntry(unsynced_0loss), &mt_t3 },
  { timedEvent::PRITRIG, 4000,  timedEventArrayTestEntry(unsynced_0loss), &mt_t4 },
  { timedEvent::PRITRIG, 5000,  timedEventArrayTestEntry(unsynced_0loss), &mt_t5 },
  { timedEvent::PRITRIG, 6000,  timedEventArrayTestEntry(unsynced_0loss), &mt_t6 },
  { timedEvent::PRITRIG, 7000,  timedEventArrayTestEntry(unsynced_0loss), &mt_t7 },
  { timedEvent::PRITRIG, 8000,  timedEventArrayTestEntry(unsynced_0loss), &mt_t8 },
  { timedEvent::PRITRIG, 9000,  timedEventArrayTestEntry(unsynced_0loss), &mt_t9 },
  { timedEvent::PRITRIG, 10000, timedEventArrayTestEntry(unsynced_0loss), &mt_t10 },
  { timedEvent::PRITRIG, 11000, timedEventArrayTestEntry(unsynced_0loss), &mt_t11 },
  { timedEvent::PRITRIG, 13000, timedEventArrayTestEntry(mt_test0_sync), &mt_t1 },
  { timedEvent::PRITRIG, 14000, timedEventArrayTestEntry(mt_test0_sync), &mt_t2 },
  { timedEvent::PRITRIG, 15000, timedEventArrayTestEntry(mt_test0_sync), &mt_t3 },
  { timedEvent::PRITRIG, 16000, timedEventArrayTestEntry(mt_test0_sync), &mt_t4 },
  { timedEvent::PRITRIG, 17000, timedEventArrayTestEntry(mt_test0_sync), &mt_t5 },
  { timedEvent::PRITRIG, 18000, timedEventArrayTestEntry(mt_test0_sync), &mt_t6 },
  { timedEvent::PRITRIG, 19000, timedEventArrayTestEntry(mt_test0_sync), &mt_t7 },
  { timedEvent::PRITRIG, 20000, timedEventArrayTestEntry(mt_test0_sync), &mt_t8 },
  { timedEvent::PRITRIG, 21000, timedEventArrayTestEntry(mt_test0_sync), &mt_t9 },
  { timedEvent::PRITRIG, 22000, timedEventArrayTestEntry(mt_test0_sync), &mt_t10 },
  { timedEvent::PRITRIG, 23000, timedEventArrayTestEntry(mt_test0_sync), &mt_t11 },
  { timedEvent::PRITRIG, 25000, timedEventArrayTestEntry(mt_test0_sync), &mt_t1 },
  { timedEvent::PRITRIG, 26000, timedEventArrayTestEntry(mt_test0_sync), &mt_t2 },
  { timedEvent::PRITRIG, 27000, timedEventArrayTestEntry(mt_test0_sync), &mt_t3 },
  { timedEvent::PRITRIG, 28000, timedEventArrayTestEntry(mt_test0_sync), &mt_t4 },
  { timedEvent::PRITRIG, 29000, timedEventArrayTestEntry(mt_test0_sync), &mt_t5 },
  { timedEvent::PRITRIG, 30000, timedEventArrayTestEntry(mt_test0_sync), &mt_t6 },
  { timedEvent::PRITRIG, 31000, timedEventArrayTestEntry(mt_test0_sync), &mt_t7 },
  { timedEvent::PRITRIG, 32000, timedEventArrayTestEntry(mt_test0_sync), &mt_t8 },
  { timedEvent::PRITRIG, 33000, timedEventArrayTestEntry(mt_test0_sync), &mt_t9 },
  { timedEvent::PRITRIG, 34000, timedEventArrayTestEntry(mt_test0_sync), &mt_t10 },
  { timedEvent::PRITRIG, 35000, timedEventArrayTestEntry(mt_test0_sync), &mt_t11 },
  { timedEvent::PRITRIG, 37000, timedEventArrayTestEntry(mt_test0_sync), &mt_t1 },
  { timedEvent::STALL,   150000, timedEventArrayTestEntry(unsynced_0loss) },
  { timedEvent::PRITRIG, 151000, timedEventArrayTestEntry(unsynced_0loss), &mt_t9 },
  { timedEvent::PRITRIG, 152000, timedEventArrayTestEntry(unsynced_0loss), &mt_t10 },
  { timedEvent::PRITRIG, 153000, timedEventArrayTestEntry(unsynced_0loss), &mt_t11 },
