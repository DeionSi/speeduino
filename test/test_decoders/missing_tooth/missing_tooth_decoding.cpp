...
/*  { timedEvent::PRITRIG, 1000,  testGroupEntry(unsynced_0loss), &mt_test0_t1 },
  ...
  { timedEvent::PRITRIG, 4000,  testGroupEntry(unsynced_0loss), &mt_test0_t4 },*/
  { timedEvent::PRITRIG, 5000,  testGroupEntry(unsynced_0loss), &mt_test0_t5 },
  { timedEvent::PRITRIG, 6000,  testGroupEntry(unsynced_0loss), &mt_test0_t6 },
  { timedEvent::PRITRIG, 7000,  testGroupEntry(unsynced_0loss), &mt_test0_t7 },
  { timedEvent::PRITRIG, 8000,  testGroupEntry(unsynced_0loss), &mt_test0_t8 },
  { timedEvent::PRITRIG, 9000,  testGroupEntry(unsynced_0loss), &mt_test0_t9 },
  { timedEvent::PRITRIG, 10000, testGroupEntry(unsynced_0loss), &mt_test0_t10 },
  ...
  { timedEvent::PRITRIG, 15000, testGroupEntry(mt_test0_sync), &mt_test0_t3 },
  { timedEvent::PRITRIG, 16000, testGroupEntry(mt_test0_sync), &mt_test0_t4 },
  { timedEvent::PRITRIG, 17000, testGroupEntry(mt_test0_sync), &mt_test0_t5 },
  { timedEvent::PRITRIG, 18000, testGroupEntry(mt_test0_sync), &mt_test0_t6 },
  { timedEvent::PRITRIG, 19000, testGroupEntry(mt_test0_sync), &mt_test0_t7 },
  { timedEvent::PRITRIG, 20000, testGroupEntry(mt_test0_sync), &mt_test0_t8 },
  { timedEvent::PRITRIG, 21000, testGroupEntry(mt_test0_sync), &mt_test0_t9 },
  ...
  { timedEvent::PRITRIG, 27000, testGroupEntry(mt_test0_sync), &mt_test0_t3 },
  { timedEvent::PRITRIG, 28000, testGroupEntry(mt_test0_sync), &mt_test0_t4 },
  { timedEvent::PRITRIG, 29000, testGroupEntry(mt_test0_sync), &mt_test0_t5 },
  { timedEvent::PRITRIG, 30000, testGroupEntry(mt_test0_sync), &mt_test0_t6 },
  { timedEvent::PRITRIG, 31000, testGroupEntry(mt_test0_sync), &mt_test0_t7 },
  { timedEvent::PRITRIG, 32000, testGroupEntry(mt_test0_sync), &mt_test0_t8 },
  { timedEvent::PRITRIG, 33000, testGroupEntry(mt_test0_sync), &mt_test0_t9 },
  { timedEvent::PRITRIG, 34000, testGroupEntry(mt_test0_sync), &mt_test0_t10 },
...
//  { timedEvent::PRITRIG, 158000, testGroupEntry(mt_test0_sync), &mt_t4 }, // Simulated lost trigger
  ...
  { timedEvent::PRITRIG, 169000, testGroupEntry(mt_test0_syncloss1), &mt_test0_t3 },
  { timedEvent::PRITRIG, 170000, testGroupEntry(mt_test0_syncloss1), &mt_test0_t4 },
  { timedEvent::PRITRIG, 171000, testGroupEntry(mt_test0_syncloss1), &mt_test0_t5 },
  { timedEvent::PRITRIG, 172000, testGroupEntry(mt_test0_syncloss1), &mt_test0_t6 },
  { timedEvent::PRITRIG, 173000, testGroupEntry(mt_test0_syncloss1), &mt_test0_t7 },
